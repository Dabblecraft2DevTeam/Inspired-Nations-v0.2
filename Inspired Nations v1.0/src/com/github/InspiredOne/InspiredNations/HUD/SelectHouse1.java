...
public class SelectHouse1 extends StringPrompt {
	...
	// Constructor
	public SelectHouse1(InspiredNations instance, Player playertemp, int errortemp) {
		plugin = instance;
		player = playertemp;
	...
	public Prompt acceptInput(ConversationContext arg0, String arg) {
		...
		try {
			...
			return new SelectHouse1(plugin, player,1);
		}
		
		if (answer > inputs.size()-1) {
			return new SelectHouse1(plugin, player, 2);
		}
